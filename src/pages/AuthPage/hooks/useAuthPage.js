import { encryptData, isErrorResponse } from "../../../utils/cryptoUtils";
...
import { notify } from "../../../components/common/NoticeToast";
...
const useAuthPage = () => {
  ...
  const onFinish = async (payload) => {
    ...
    try {
      ...
      if (errorCode && errorCode.status === HTTP_STATUS.CLIENT_ERROR.UNAUTHORIZED) {
